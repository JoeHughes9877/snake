...
while True:
    ...
    # Update the score after updating the snake
    score = FONT.render(f"{len(snake.body) + 1}", True, "white")
    score_rect = score.get_rect(center=(SW / 2, BLOCK_SIZE))  # Update score position
    ...
    screen.blit(score, score_rect)  # Draw the score
